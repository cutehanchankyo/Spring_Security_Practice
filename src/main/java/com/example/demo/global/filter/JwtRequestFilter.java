...
import com.example.demo.global.configuration.security.auth.MyUserDetailService;
...
import com.example.demo.global.exception.error.TokenNotValidException;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException{
        ...
        if(accessToken != null){
            if(tokenProvider.isTokenExpired(accessToken)){
                throw new TokenExpiredException("Access is expried", ErrorCode.TOKEN_EXPIRED);
            }
